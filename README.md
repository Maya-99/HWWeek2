...
-------------------------
My homework assignment week 2

Although I really felt like I could be able to finish these assignments unlike last weeks, it seems I could not. 
Unlike last week I really though I knew what I was doing.
All the topics I have practised, with success. Not even having to check when I would practice in the evening.
However even feeling really confident I have understood all the topics discussed, the assignments don't show it at all.
Eventually restarted the assignments 3 times over each, and spend again about 14 hours on it, and eventually trying whatever just to make the test pass is not my way to go. 
The amount of effort, time and energy I've spend, do not pay off in the week assignment, which is very discouraging to say the least. So go ahead and laugh at me, while I'll spend my time learning coding a more effective way. 
